...
function AdminAppointmentCalendar() {
  ...
  const renderCalendarNavigation = () => {
    return (
      <Box sx={{ 
        ...
        <Box sx={{ width: 40 }} /> {/* Empty space to maintain layout balance */}
      </Box>
    );
  };
              ...
              {weekDays.map(day => (
                <Box 
                  ...
                  sx={{ 
                    ...
                    borderRight: '1px solid #e0e0e0',
                    position: 'relative',
                    backgroundColor: isToday(day) ? 'rgba(25, 118, 210, 0.04)' : 'transparent',
                    '&:hover': {
                      backgroundColor: isToday(day) ? 'rgba(25, 118, 210, 0.08)' : 'rgba(0, 0, 0, 0.01)'
                    }
                  }}
                >
                  {/* Day header */}
    ...
    return (
      <Box sx={{ mt: 3 }}>
        ...
        <Box sx={{ 
          ...
          {/* Day headers */}
          <Grid container sx={{ bgcolor: 'primary.light', borderBottom: '1px solid #e0e0e0' }}>
          ...
          <Box>
            {weeks.map((week, weekIndex) => (
              <Grid container key={weekIndex} sx={{ 
                borderBottom: weekIndex < weeks.length - 1 ? '1px solid #e0e0e0' : 'none',
                '&:hover': {
                  ...
                  return (
                    <Grid 
                      ...
                      sx={{ 
                        ...
                        p: 1, 
                        borderRight: '1px solid #e0e0e0',
                        bgcolor: isToday(day) ? 'primary.light' : isCurrentMonth ? 'white' : 'grey.50',
                        color: isToday(day) ? 'white' : isCurrentMonth ? 'inherit' : 'text.disabled',
                        position: 'relative',
                        overflow: 'hidden',
                        transition: 'all 0.2s ease',
                        '&:hover': {
                          backgroundColor: isToday(day) ? 'primary.main' : isCurrentMonth ? 'grey.100' : 'grey.100'
                        }
                      }}
                    >
                      <Box sx={{
                        ...
                        justifyContent: 'center',
                        borderRadius: '50%',
                        backgroundColor: isToday(day) ? 'white' : 'transparent',
                      }}>
                        <Typography 
                          variant="body2" 
                          sx={{ 
                            fontWeight: isToday(day) ? 'bold' : 'medium',
                            color: isToday(day) ? 'primary.main' : isCurrentMonth ? 'text.primary' : 'text.disabled',
                            lineHeight: 1
                          }}
                        >
                          {format(day, 'd')}
                      ...
                      <Box sx={{ 
                        ...
                        {dayAppointments.slice(0, 3).map(appointment => (
                          ...
                          >
                            <Box sx={{ display: 'flex', alignItems: 'center' }}>
                              <AccessTimeIcon sx={{ fontSize: '0.7rem', mr: 0.5, opacity: 0.9 }} />
                              <Typography 
                                component="span" 
                                sx={{ 
                                  fontSize: '0.75rem',
                        ...
                        {dayAppointments.length > 3 && (
                          <Typography 
                            ...
                            sx={{ 
                              ...
                              backgroundColor: isToday(day) ? 'rgba(255,255,255,0.2)' : 'rgba(0,0,0,0.05)',
                              borderRadius: 1,
                              p: 0.5,
                              fontWeight: 500
                            }}
  ...
  return (
    <Paper sx={{ p: 3, borderRadius: 2, boxShadow: '0px 2px 8px rgba(0, 0, 0, 0.08)' }}>
      ...
      {/* List View */}
      {viewMode === 'list' && (
        <Box sx={{ p: 3, bgcolor: 'background.paper', borderRadius: 2, boxShadow: '0px 2px 8px rgba(0, 0, 0, 0.05)' }}>
          <Box sx={{ 
            display: 'flex', 
            justifyContent: 'space-between', 
            alignItems: 'center', 
