...
import { Box, Grid, TextField, InputAdornment, MenuItem, FormControl, Select, InputLabel } from '@mui/material';
        ...
        <Box
          sx={{
            backgroundColor: 
              ...
              params.value === 'active' ? 'info.light' : 'warning.light',
            color: 
              params.value === 'completed' ? 'success.dark' : 
              params.value === 'active' ? 'info.dark' : 'warning.dark',
            borderRadius: 1,
            px: 1,
            py: 0.5,
