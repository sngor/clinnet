// src/features/appointments/components/FrontdeskAppointmentHistory.jsx
...
function FrontdeskAppointmentHistory() {
  ...
  const handleCheckout = () => {
    // In a real app, this would redirect to the checkout page with the appointment pre-selected
    alert(`Redirecting to checkout for ${selectedAppointment.patient}`);
    setDetailDialogOpen(false);
  };
  ...
  const paymentStatuses = [...new Set(mockPastAppointments.map(appointment => appointment.paymentStatus))];
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
                    ...
                    <Box sx={{ display: 'flex', gap: 1 }}>
                      ...
                      <Chip 
                        ...
                        color={getPaymentStatusColor(selectedAppointment.paymentStatus)} 
                        size="small"
                      />
                    </Box>
                  </Box>
            ...
            <DialogActions>
              ...
              <Button 
                ...
                onClick={() => {
                  ...
                  alert(`Navigating to ${selectedAppointment.patient}'s profile`);
                }}
              >
                View Patient
              </Button>
...
export default FrontdeskAppointmentHistory;